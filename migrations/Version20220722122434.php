 ...
 */
final class Version20220722122434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game AS SELECT id, category_id, title, slug, content, image, created_at, updated_at FROM game');
        ...
        $this->addSql('INSERT INTO game (id, category_id, title, slug, content, image, created_at, updated_at) SELECT id, category_id, title, slug, content, image, created_at, updated_at FROM __temp__game');
